...
$usuario = $administracion->obtener_usuario($token);
        ...
        <form action="#" method="post" id="form_abc" enctype="multipart/form-data">
            <div class="row mb-3">
                <div class="col-sm-4">
                    ...
                    <input type="text" name="usuario" id="usuario" class="form-control" value="<?php echo $usuario['usuario'][0] ?>">
                </div>
                <div class="col-sm-4">
                    <label>Contraseña</label>
                    <input type="password" name="password" id="password" class="form-control" value="<?php echo $usuario['password'][0] ?>">
                </div>
                <div class="col-sm-4">
                    <label>Nivel de usuario</label>
                    <select name="nivel" id="nivel" class="form-control">
                        <option value="" selected>Selecciona una opción</option>
                        <option value="1" <?php echo $usuario['nivel'][0] == 1 ? 'selected' : ''; ?>>Administrador</option>
                        <option value="2" <?php echo $usuario['nivel'][0] == 2 ? 'selected' : ''; ?>>Vendedor</option>
                    </select>
                </div>
            </div>
            <div class="row">
