...
$categoria = $admin->obtener_categorias();
$ccategoria = $funcion->cuentarray($categoria);
?>
<div class="row mb-2">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-striped table-centered mb-0" id="tabla">
                    ...
                    <tbody>
                        <?php
                        for ($i = 0; $i < $ccategoria; $i++) { ?>
                            <tr>
                                <td><?php echo $categoria['nombre'][$i]; ?></td>
                                <td><?php echo $categoria['estatus'][$i]; ?></td>
                                <td><?php echo $categoria['descripcion'][$i]; ?></td>
                                <td class="table-action">
                                    <a href="javascript: void(0);" class="btn btn-success m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar" onClick="Vista('<?php echo $menu; ?>','<?php echo $modulo; ?>','abc','editar','<?php echo md5($categoria['id'][$i]); ?>')"> <i class="fal fa-pencil"></i></a>
                                    <a href="javascript: void(0);" class="btn btn-danger m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar" onClick="Vista('<?php echo $menu; ?>','<?php echo $modulo; ?>','abc','eliminar','<?php echo md5($categoria['id'][$i]); ?>')"> <i class="fal fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
