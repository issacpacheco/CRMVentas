...
$categoria = $administracion->obtener_categoria($token);
    ...
    <div class="col-sm-12">
        <form action="#" method="post" id="form_abc" enctype="multipart/form-data">
            <div class="row mb-3">
                <div class="col-sm-4">
                    <label>Nombre</label>
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $categoria['nombre'][0] ?>">
                </div>
                <div class="col-sm-4">
                    <label>Estatus</label>
                    <select name="estatus" id="estatus" class="form-control">
                        <option value="" selected>Selecciona una opción</option>
                        <option value="1" <?php echo $categoria['estatus'][0] == 1 ? 'selected' : ''; ?>>Activo</option>
                        <option value="2" <?php echo $categoria['estatus'][0] == 2 ? 'selected' : ''; ?>>inactivo</option>
                    </select>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-sm-12">
                    ...
                    <textarea name="descripcion" id="descripcion" class="form-control"><?php echo $categoria['descripcion'][0] ?></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-8">
