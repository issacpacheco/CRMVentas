...
$venta = $puntoventa->obtener_ventas();
$cventa = $funcion->cuentarray($venta);
?>
<div class="row mb-2">
    <div class="col-12">
                ...
                <div id="contenedor_tabla">
                    <table class="table table-striped table-centered mb-0" id="tabla">
                        ...
                        <tbody>
                            ...
                            for ($i = 0; $i < $cventa; $i++) { ?>
                                <tr>
                                    <td><?php echo $venta['id_usuario_vendido'][$i]; ?></td>
                                    <td><?php echo $venta['id_cliente'][$i]; ?></td>
                                    <td><?php echo $venta['total'][$i]; ?></td>
                                    <td><?php echo $venta['fecha_venta'][$i]; ?></td>
                                    <td class="table-action">
                                        <a href="javascript: void(0);" class="btn btn-success m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar" onClick="Vista('<?php echo $menu; ?>','<?php echo $modulo; ?>','abc','editar','<?php echo md5($venta['id'][$i]); ?>')"> <i class="fal fa-pencil"></i></a>
                                        <a href="javascript: void(0);" class="btn btn-danger m-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar" onClick="Vista('<?php echo $menu; ?>','<?php echo $modulo; ?>','abc','eliminar','<?php echo md5($venta['id'][$i]); ?>')"> <i class="fal fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
