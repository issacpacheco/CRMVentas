...
$cliente = $administracion->obtener_cliente($token);
    ...
    <div class="col-sm-12">
        <form action="#" method="post" id="form_abc" enctype="multipart/form-data">
            <div class="row mb-3">
                <div class="col-sm-4">
                    <label>Nombre</label>
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo $cliente['nombre'][0] ?>">
                </div>
                <div class="col-sm-4">
                    <label>Correo</label>
                    <input type="text" name="correo" id="correo" class="form-control" value="<?php echo $cliente['correo'][0] ?>">
                </div>
                <div class="col-sm-4">
                    <label>Télefono</label>
                    <input type="text" name="telefono" id="telefono" class="form-control" value="<?php echo $cliente['telefono'][0]; ?>">
                </div>
            </div> 
            <div class="row">
                <div class="col-sm-8">
